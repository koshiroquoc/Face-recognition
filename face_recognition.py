...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        heading = Label(bg_img, text="Hệ thống điểm danh lớp học", font=("yu gothic ui", 20, "bold"), bg="white",
                        fg="red2",
                        bd=0, relief=FLAT)
        ...
        #IDHS
        self.studentID_label = Label(self.studentID_atten_info, text="ID Học sinh:", font=("times new roman", 13, "bold"), bg="white")
        ...
        #TenHS
        self.studentname_label = Label(self.studentID_atten_info, text="Tên Học sinh:", font=("times new roman", 13, "bold"),
                                     bg="white")
        ...
        #Class
        self.className_label = Label(self.RightU_frame, text="Lớp học:",
                        ...
                        if(self.type_attendance.get()=="Vào"):
                            if((d1 not in a)) or ((self.lessonid not in b)):
                                ...
                                if(time_in<time_start):
                                    ...
                                    d = datetime.strptime('1:00:00', '%H:%M:%S').time()#thoi gian cho phep hoc sinh vang 1 tiet
                            ...
                            if(masp not in att):
                                if ((d1 not in a)) or ((self.lessonid not in b)):
                                    ...
                                    # print(
                                    #     "Hoc sinh:" + n + " Đã điểm danh ngày " + d1 + ". Vui lòng ra khỏi Camera !!")
                                    self.notify_label[
