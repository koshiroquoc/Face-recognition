...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl=Label(bg_img,text="Hệ thống điểm danh bằng nhận diện khuôn mặt",font=("times new roman",25,"bold"),bg="white",fg="blue")
        ...
        b1_1 = Button(bg_img, text="Thông tin học sinh", cursor="hand2",command=self.student_details,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
