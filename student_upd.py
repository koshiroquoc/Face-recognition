...
class Student:
    def __init__(self,root):
        ...
        # ====title=========
        self.txt = "Quản lý thông tin học sinh"
        self.count = 0
        self.text = ''
        ...
        #department
        dep_label=Label(current_course_frame,text="Hình thức",font=("times new roman",13,"bold"),bg="white")
        ...
        dep_combo["values"]=("Chính khóa","Ngoại khóa")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)


        #course
        course_label = Label(current_course_frame, text="Buổi dạy", font=("times new roman", 13, "bold"), bg="white")
        ...
        course_combo["values"] = ("Sáng","Chiều")
        ...
        year_combo = ttk.Combobox(current_course_frame,textvariable=self.var_year, font=("times new roman", 13, "bold"), state="readonly",
                                    width=20)
        year_combo["values"] = ("2021-22", "2022-23", "2023-24")
        ...
        semester_combo = ttk.Combobox(current_course_frame,textvariable=self.var_semester ,font=("times new roman", 13, "bold"), state="readonly",
                                  width=20)
        semester_combo["values"] = ("Học kì I", "Học kì II")
        ...
        #student_id
        studentID_label = Label(class_student_frame, text="ID học sinh:", font=("times new roman", 13, "bold"), bg="white")
        ...
        #studentName
        studentName_label = Label(class_student_frame, text="Tên học sinh:", font=("times new roman", 13, "bold"),
                                bg="white")
        ...
        take_photo_btn = Button(btn_frame1, text="Lấy ảnh học sinh",command=self.generate_dataset, font=("times new roman", 13, "bold"), bg="#38a6f0", fg="white",
                           width=35)
        ...
        search_combo["values"] = ("ID học sinh", "Tên học sinh", "Lớp học")
        ...
        self.student_table.heading("dep",text="Hình thức")
    ...
    def getNextid(self):
        conn = mysql.connector.connect(host='localhost', user='root', password='', database='qlhocsinh',
                                       port='3306')
    ...
    def add_data(self):
        ...
        if self.var_dep.get()=="Chọn Hình thức" or self.var_std_name.get()=="" or self.var_std_id.get()=="" or self.var_div.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host='localhost', user='root', password='', database='qlhocsinh', port='3306')
    ...
    def update_data(self):
        if self.var_dep.get()=="Hình thức" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            messagebox.showerror("Error","Vui lòng nhập đầy đủ thông tin",parent=self.root)
        else:
            try:
    ...
    #===================Reset function====================
    def reset_data(self):
        self.var_dep.set("Hình thức"),
        self.var_course.set("Buổi dạy"),
    ...
    def search_data(self):
            if self.var_com_search.get() == "" or self.var_search.get() == "":
                ...
                try:
                    ...
                    elif (self.var_com_search.get() == "Lớp học"):
    ...
    def train_classifier(self):
        ...
        cv2.destroyAllWindows()
        messagebox.showinfo("Kết quả","Train dữ liệu thành công !",parent=self.root)
