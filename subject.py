...
class Subject:
    def __init__(self,root):
        ...
        # nclass
        nameLabel = Label(left_inside_frame, text="Lớp học:", font=("times new roman", 12, "bold"),
                          bg="white")
        ...
        teacherid_label = Label(Underleft_frame, text="ID giáo viên:", font=("times new roman", 12, "bold"),
                                    bg="white",width=12)
        ...
        studentid_label = Label(Underright_frame, text="ID học sinh:", font=("times new roman", 12, "bold"),
                                bg="white", width=12)
    ...
    def add_Tcdata(self):
        ...
        if self.var_teachersub.get()=="" or self.var_subsub.get()=="" :
            ...
            messagebox.showerror("Error", "Môn học này đã có giáo viên! Vui lòng kiểm tra lại", parent=self.root)
