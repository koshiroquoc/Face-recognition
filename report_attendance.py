...
class Report:
    def __init__(self,root):
        ...
        # ========title=========
        self.txt = "Thống kê thông tin các buổi học"
        self.count = 0
        self.text = ''
        ...
        student_text=Label(student_frame,text="Số học sinh",font=("times new roman", 20, "bold"),fg="white",bg="#27a9e3")
        ...
        search_combo = ttk.Combobox(late_group, font=("times new roman", 12, "bold"),
                                    ...
                                    state="read only",
                                    width=12)
        search_combo["values"] = ("ID học sinh", "Ngày","Tên môn học","ID Buổi học")
        ...
        self.LateTable.heading("studentid", text="Mã HS")
        ...
        self.NoAttTable.heading("studentid", text="Mã HS")
        ...
        noatt_lbl = Label(Right_frame, bd=0, bg="white", text="học sinh không điểm danh", font=("yu gothic ui", 14, "bold"),
                         fg="red2", )
        ...
        self.NotInTable.heading("studentid", text="Mã HS")
    ...
    def exportCsv(self):
        try:
            ...
            with open('Attendance_CSV/diemdanhmuon.csv',mode="w",newline="",encoding="utf-8") as myfile:
                ...
                exp_write.writerow(('ID học sinh', 'Tên học sinh', 'Ngày', 'Môn học', 'ID Buổi học', 'Trạng thái'))
                for i in mydata:
    ...
    def exportNotinCsv(self):
        try:
            ...
            with open('Attendance_CSV/khongdiemdanh.csv',mode="w",newline="",encoding="utf-8") as myfile:
                ...
                exp_write=csv.writer(myfile,delimiter=",")
                exp_write.writerow(('ID học sinh', 'Tên học sinh', 'Ngày', 'Môn học', 'ID Buổi học'))
