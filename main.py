...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #background
        print(value_from_p1)
        img3 = PIL.Image.open(r"ImageFaceDetect\bgbtn-1.png")
        ...
        time_img.place(x=1150, y=45, width=27, height=27)
        self.lblemail = Label(self.root,text=self.account, font=("yu gothic ui", 12, "bold"), bg="white", fg="green")
        self.lblemail.place(x=1180, y=48, width=150, height=22)
        ...
        btn2 = Button(self.root, text="Học sinh", font=("yu gothic ui", 16, "bold"),command=self.student_details, image=self.photobtn2,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
