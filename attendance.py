...
class Attendance:
    ...
    def __init__(self,root):
        ...
        self.AttendanceReportTable=ttk.Treeview(table_frame,column=("id","idhs","name","class","time_in","time_out","date","lesson","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.AttendanceReportTable.heading("idhs", text="ID Học sinh")
        ...
        self.AttendanceReportTable.column("idhs", width=100)
    ...
    def exportCsv(self):
        # try:
            ...
            with open('Attendance_CSV/diemdanh.csv',mode="w",newline="",encoding="utf-8") as myfile:
                ...
                exp_write.writerow(('Mã Điểm danh', 'ID Học sinh', 'Tên Học sinh', 'Lớp học', 'Giờ vào', 'Giờ ra', 'Ngày', 'ID Buổi học', 'Trạng thái'))
                for i in mydata:
