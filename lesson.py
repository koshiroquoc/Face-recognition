...
class Lesson:
    def __init__(self,root):
        ...
        teacherLabel = Label(left_inside_frame, text="ID giáo viên:", font=("times new roman", 12, "bold"),
                           bg="white")
        ...
        teachernLabel = Label(left_inside_frame, text="Tên giáo viên:", font=("times new roman", 12, "bold"),
                             bg="white")
